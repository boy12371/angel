...
public class TimeSpanTest{
	...
	public void TestGetDays() throws ParseException{
		long millis = DateUtil.getDefaultDate("2011-1-1 5:6:7", DateUtil.DEFAULT_DATETIME_HYPHEN_FORMAT).getTime()-DateUtil.getDefaultDate("2010-1-1 0:0:0", DateUtil.DEFAULT_DATETIME_HYPHEN_FORMAT).getTime();
	...
	public void TestGetTotalSeconds() throws ParseException{
		long millis = DateUtil.getDefaultDate("2011-1-1 5:6:7", DateUtil.DEFAULT_DATETIME_HYPHEN_FORMAT).getTime()-DateUtil.getDefaultDate("2010-1-1 0:0:0", DateUtil.DEFAULT_DATETIME_HYPHEN_FORMAT).getTime();
		TimeSpan ts=new TimeSpan(millis);
		Assert.assertEquals(((365*24+5)*60+6)*60+7, ts.getTotalSeconds());
	}
