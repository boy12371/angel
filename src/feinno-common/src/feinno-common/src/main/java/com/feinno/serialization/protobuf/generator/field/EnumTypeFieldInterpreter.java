...
public class EnumTypeFieldInterpreter extends AbstractFieldInterpreter {
	 ...
	 * <code>if(data.getEnumType() != null){ java.lang.Character value = data.getEnumType().key(); size += com.feinno.serialization.protobuf.CodedOutputStream.computeInt32Size(1,value);}</code>
	 * <br>
	 * 的输出
	 */
	 ...
	 * if(fieldValue != null){
	 * 		EnumType.valueOf((Class<? extends com.feinno.util.EnumType<${java_type}, ?>>com.feinno.util.EnumType.getClass(),fieldValue));
	 * }
	 * data.getEnumType();</code> <br>
	 * 的输出
	 */
	private static final String PARSE_CODE_TEMPLATE = " ${java_type} fieldValue = null; ${parse_array} if(fieldValue!=null){ ${data}.${setterName}(com.feinno.util.EnumType.valueOf(${java_real_type}.class,fieldValue));}";
