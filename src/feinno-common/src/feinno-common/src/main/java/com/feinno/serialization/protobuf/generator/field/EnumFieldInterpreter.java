...
public class EnumFieldInterpreter extends AbstractFieldInterpreter {
	 ...
	 * <code>data.setEnum_obj((com.test.serialization.PersonEnum)com.feinno.util.EnumParser.parseInt(com.test.serialization.PersonEnum.class,input.readEnum()));</code>
	 * <br>
	 * 的输出
	 */
	private static final String PARSE_CODE_TEMPLATE = "${data}.${setterName}((${enum_class})com.feinno.util.EnumParser.parseInt(${enum_class}.class,${input}.read${streamType}()));";
	...
	/**
	 * 表示反序列化代码的格式，期待一个类似于<br>
	 * <code>fieldValue = (com.test.serialization.PersonEnum)com.feinno.util.EnumParser.parseInt(com.test.serialization.PersonEnum.class,input.readEnum());</code>
	 * <br>
	 * 的输出
	 */
	private static final String PARSE_CODE_ARRAY_TEMPLATE = "fieldValue = (${enum_class})com.feinno.util.EnumParser.parseInt(${enum_class}.class,${input}.read${streamType}());";
