...
//		if (Void.class.equals(anno.argsType())) {
//			mh.setArgsCodec(Serializer.getCodec(anno.argsType()));			
//		}
//		if (Void.class.equals(anno.resultsType())) {
//			mh.setResultsCodec(Serializer.getCodec(anno.resultsType()));
//		}
		return mh;
	}
}
