...
public class TestDatabaseLog {

	private static final Logger LOGGER = LoggerFactory.getLogger(TestDatabaseLog.class);
	...
	public static void main(String args[]) throws Exception {
		...
		props.load(new FileInputStream(TestConsoleLog.class.getResource("").getPath()+"\\logging.database.properties"));
