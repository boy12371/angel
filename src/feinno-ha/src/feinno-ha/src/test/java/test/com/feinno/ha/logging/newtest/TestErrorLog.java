...
public class TestErrorLog {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(TestErrorLog.class);
	...
	public static void main(String args[]) throws Exception {
		...
		props.load(new FileInputStream(TestConsoleLog.class.getResource("").getPath()+"\\logging.error.properties"));
