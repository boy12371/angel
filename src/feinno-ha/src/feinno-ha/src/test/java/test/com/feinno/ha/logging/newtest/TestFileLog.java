...
public class TestFileLog {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(TestFileLog.class);
	...
	public static void main(String args[]) throws Exception {
		...
		props.load(new FileInputStream(TestConsoleLog.class.getResource("").getPath()+"\\logging.file.properties"));
