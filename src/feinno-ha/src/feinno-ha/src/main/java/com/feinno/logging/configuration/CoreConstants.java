...
/**
 * 这是一个logback中提供的常量类，将它提取到我们的日志中来，目的是其中有部分常量可以用到，部分用不到的，也可以留作以后的扩展
 * 
 * @author Lv.Mingwei
 * 
 */
public class CoreConstants {
	 ...
	 * string argument can restore a given object from its string
	 * representation.
	 */
	...
	/**
	 * Number of rows before in an HTML table before, we close the table and
	 * create a new one
	 */
